...
binned_datapath = "G:\\Dev\\Data\\10000\\GNPS Python 10000 Binned"
        ...
        with open(filepath, 'r') as f:
            ...
            for line in unsplit_lines:
                if ' ' in line:  # Only lines with mass and intensity values have a space. Ignores label/blank lines
                    ...
                    mass = round(float(split_line[0]), 1)  # Mass of fragment, to nearest 1 decimal point Da
                    if mass <= MAX_MASS:  # If fragment isn't too big
                        mass_bin = int((mass * 10) // bin_size) - 1  # Bin fragment belongs in.
